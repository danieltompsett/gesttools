...
#' an individuals ID.
#' @param timevar A character string specifying the name of the variable specifying time
...
#' @param varying A vector of character strings specifying the names of relevant variables which are
...
#'
#' @details Note that any variable in \code{varying} that is strictly categorical MUST be set to
...
if(GenerateHistory==TRUE){
  ...
  #Remove first lagged exposure as it is already generates by functions
