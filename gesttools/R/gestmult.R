...
#' a time varying outcome \eqn{Y_s=y_s} is measured over times \eqn{s=2,\ldots,T+1}. Define \eqn{c=s-t} as the step length, that is the number of time periods separating an exposure measurement, and subsequent outcome measurement.
...
#' Cn="C"
#' LnC=c("L","U")
#' gestmult(data,idvar,timevar,Yn,An,Ybin,Abin,Lny,Lnp,type=1,Cn,LnC)
#'
