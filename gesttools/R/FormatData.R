...
#' If \code{Cn} is specified, it is added to varying automatically.
...
#' corresponding to the lagged histories of all variables included in \code{varying} (except \code{Cn}), that
...
#' an \code{as.factor()} variable. Binary or continuous variables should be set to an
